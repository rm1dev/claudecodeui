...
- **Search first.** Check [existing issues](https://github.com/rm1dev/claudecodeui/issues) and [pull requests](https://github.com/rm1dev/claudecodeui/pulls) to avoid duplicating work.
- **Discuss first** for new features. Open an [issue](https://github.com/rm1dev/claudecodeui/issues/new) to discuss your idea before investing time in implementation. We may already have plans or opinions on how it should work.
