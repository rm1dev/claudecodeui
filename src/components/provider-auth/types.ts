...
export const CLI_PROVIDERS: LLMProvider[] = ['claude', 'cursor', 'codex', 'gemini', 'gapcode'];
...
export const PROVIDER_AUTH_STATUS_ENDPOINTS: Record<LLMProvider, string> = {
  ...
  gapcode: '/api/providers/gapcode/auth/status',
};
...
export const createInitialProviderAuthStatusMap = (loading = true): ProviderAuthStatusMap => ({
  ...
  gapcode: { authenticated: false, email: null, method: null, error: null, loading },
});
